...
def create_yaml_config(target_dir, plu_mapping):
    ...
    yaml_content = f"""path: ../
train: /Users/brage/Documents/Astar-hackathon-25/DELIVERY/PROBLEM1/src/images/train
val: /Users/brage/Documents/Astar-hackathon-25/DELIVERY/PROBLEM1/src/images/val
test: /Users/brage/Documents/Astar-hackathon-25/DELIVERY/PROBLEM1/src/images/test
nc: {len(plu_mapping)}
names:
"""
...
def main():
    ...
    print(
        f"Split ratios: Train {SPLIT_RATIOS['train'] * 100:.0f}%, Val {SPLIT_RATIOS['val'] * 100:.0f}%, Test {SPLIT_RATIOS['test'] * 100:.0f}%"
    )
